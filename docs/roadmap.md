...
Primary focus: release parity after the post-deploy Pages polish

Planned outcome:

- package the current `main` state so release assets include the Pages category schema polish and postdeploy dogfood log
- keep the starter bundle and GitHub Action docs pinned to the reviewed stable Action release
