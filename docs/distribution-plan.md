...
- GitHub releases with attached CLI, demo, and site assets through `v0.3.3`
...
With `v0.3.3` released on June 10, 2026, the near-term distribution bottleneck is repeatable proof and adoption follow-through rather than missing local scaffolding.
