...
- GitHub releases with attached CLI, demo, and site assets through `v0.3.4`
...
With `v0.3.4` released on June 10, 2026, the near-term distribution bottleneck is repeatable proof and adoption follow-through rather than missing local scaffolding.
