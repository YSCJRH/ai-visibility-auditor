...
- GitHub releases with attached CLI, demo, and site assets through `v0.3.6`
...
- Trust/safety, first-run story, and self-dogfood log docs for safe sharing and evidence loops
...
With `v0.3.6` released on June 20, 2026, the near-term distribution bottleneck is repeatable proof and adoption follow-through rather than missing local scaffolding.
