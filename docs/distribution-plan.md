...
- GitHub releases with attached CLI, demo, and site assets through `v0.3.5`
...
With `v0.3.5` released on June 17, 2026, the near-term distribution bottleneck is repeatable proof and adoption follow-through rather than missing local scaffolding.
