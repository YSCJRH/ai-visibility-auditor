...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "admin.topbar.runsTitle": "Runs workspace",
    "admin.topbar.runsSummary": "Start here when you need to choose the next run worth opening, then move into artifact-backed review instead of scanning the whole workspace equally.",
    "admin.topbar.runDetailTitle": "Artifact-backed review",
    "admin.topbar.runDetailSummary": "Use one issue, one fix, and the fixed artifact order to keep each run understandable before you drop into HTML preview or raw JSON.",
    "admin.topbar.presetsTitle": "Preset ladder",
    "admin.topbar.presetsSummary": "Choose the path that matches the fixture demo, AnswerLens self-dogfooding, or external starter adoption before you launch anything new.",
    "admin.nav.runs": "Runs",
    ...
    "admin.sidebar.path.title": "Operator path",
    "admin.sidebar.path.body": "Use the shell as a guided route through the same adoption flow you already expose publicly.",
    "admin.sidebar.path.item1": "Choose the closest preset path before you launch a new run.",
    "admin.sidebar.path.item2": "Treat Runs as triage, then open one run detail with intent.",
    "admin.sidebar.path.item3": "Keep the review sequence stable so teammates can follow the same trail.",
    "admin.sidebar.artifacts.title": "Primary artifacts",
    "admin.sidebar.artifacts.body": "These three files stay the fastest way to understand what happened and what should happen next.",
    "admin.sidebar.artifacts.item1": "Start with share-summary.md for the one-screen read.",
    "admin.sidebar.artifacts.item2": "Use scorecard.md to confirm structure, buckets, and issue density.",
    "admin.sidebar.artifacts.item3": "Use recommendations.md to decide what should ship next.",
    ...
    "admin.presets.runtime": "Runtime file",
    "admin.presets.runtimeDefaults": "Eval defaults",
    "admin.presets.runtimeNetwork": "Timeout and endpoint",
    ...
    "admin.presets.recommendedProfile": "Recommended profile",
    ...
    "admin.launcher.profile": "Profile",
    "admin.launcher.profile.default": "Use preset default",
    "admin.launcher.recommendedProfile": "Recommended profile",
    ...
    "admin.launcher.locale": "Eval locale",
    "admin.launcher.timeout": "Timeout (ms)",
    "admin.launcher.baseUrl": "Base URL override",
    "admin.launcher.baseUrl.placeholder": "Optional, defaults to the runtime endpoint",
    "admin.launcher.defaultTarget": "Default target",
    "admin.launcher.files": "Files",
    "admin.launcher.runtime": "Runtime file",
    "admin.launcher.runtimeDefaults": "Eval defaults",
    "admin.launcher.runtimeNetwork": "Network defaults",
  ...
  "zh-CN": {
    ...
    "admin.topbar.runsTitle": "运行工作区",
    "admin.topbar.runsSummary": "当你需要决定下一条值得打开的 run 时，就从这里开始；目标是进入产物驱动的审阅，而不是平均扫完整个工作区。",
    "admin.topbar.runDetailTitle": "产物驱动审阅",
    "admin.topbar.runDetailSummary": "先用一个问题、一个修复和固定的产物顺序把这轮 run 讲清楚，然后再进入 HTML 预览或原始 JSON。",
    "admin.topbar.presetsTitle": "预设阶梯",
    "admin.topbar.presetsSummary": "在发起新运行前，先选清楚你现在走的是 fixture demo、AnswerLens 自审，还是外部 starter adoption 路径。",
    "admin.nav.runs": "运行",
    ...
    "admin.sidebar.path.title": "操作路径",
    "admin.sidebar.path.body": "把这个壳层当成一条有引导的操作路径，走的仍然是你在公开面上讲的同一条 adoption flow。",
    "admin.sidebar.path.item1": "先选最接近当前目标的 preset，再去发起新 run。",
    "admin.sidebar.path.item2": "把 Runs 当成分诊入口，然后带着明确目的进入某一条 run 详情。",
    "admin.sidebar.path.item3": "固定审阅顺序，这样协作者也能沿着同一条路径理解结果。",
    "admin.sidebar.artifacts.title": "核心产物",
    "admin.sidebar.artifacts.body": "这三份文件仍然是最快讲清楚发生了什么、下一步该做什么的入口。",
    "admin.sidebar.artifacts.item1": "先看 share-summary.md，用一屏内容建立整体判断。",
    "admin.sidebar.artifacts.item2": "再看 scorecard.md，确认结构、分桶和问题密度。",
    "admin.sidebar.artifacts.item3": "最后看 recommendations.md，决定下一步该推进什么。",
    "admin.launch": "发起运行",
    ...
    "admin.presets.runtime": "Runtime 文件",
    "admin.presets.runtimeDefaults": "Eval 默认值",
    "admin.presets.runtimeNetwork": "超时与端点",
    ...
    "admin.presets.recommendedProfile": "推荐 profile",
    ...
    "admin.launcher.profile": "Profile",
    "admin.launcher.profile.default": "使用 preset 默认值",
    "admin.launcher.recommendedProfile": "推荐 profile",
    ...
    "admin.launcher.locale": "Eval 语言",
    "admin.launcher.timeout": "超时（毫秒）",
    "admin.launcher.baseUrl": "Base URL 覆盖",
    "admin.launcher.baseUrl.placeholder": "可选，默认使用 runtime 中的 endpoint",
    "admin.launcher.defaultTarget": "默认目标",
    "admin.launcher.files": "文件",
    "admin.launcher.runtime": "Runtime 文件",
    "admin.launcher.runtimeDefaults": "Eval 默认值",
    "admin.launcher.runtimeNetwork": "网络默认值",
