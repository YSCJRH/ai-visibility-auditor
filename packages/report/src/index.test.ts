...
test("report renderers expose expected audit and eval sections", async () => {
  ...
  assert.deepEqual(runManifest.artifacts.slice(0, 3), ["share-summary.md", "scorecard.md", "recommendations.md"]);
  ...
  assert.deepEqual(shareSummary.artifacts.slice(0, 3), ["share-summary.md", "scorecard.md", "recommendations.md"]);
