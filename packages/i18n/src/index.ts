...
const messages: Record<Locale, MessageCatalog> = {
  en: {
    ...
    "report.next.starter": "Use the AnswerLens starter bundle when this workflow is ready to move into another repository: https://github.com/YSCJRH/ai-visibility-auditor/blob/main/docs/starter-bundle.md",
  ...
  "zh-CN": {
    ...
    "report.next.starter": "当这套 workflow 准备复制到其他仓库时，使用 AnswerLens starter bundle：https://github.com/YSCJRH/ai-visibility-auditor/blob/main/docs/starter-bundle.md",
