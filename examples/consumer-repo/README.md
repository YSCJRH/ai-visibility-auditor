...
The checked-in workflow pins the current stable Action release, `YSCJRH/ai-visibility-auditor@v0.3.5`. After a newer release, update that pin only after reviewing the release notes.
